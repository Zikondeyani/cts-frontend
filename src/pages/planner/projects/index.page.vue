      ...
      <div class="flex flex-wrap justify-center md:justify-start -mx-2 mt-7">
        ...
        >
          ...
          >
            ...
            <router-link to="/planner/dispatches"
              class="block px-4 py-2 text-gray-800 hover:bg-gray-200">
              Dispatches
            </router-link>
          </div>
...
import { 
  ...
  TemplateIcon, HeartIcon, LightningBoltIcon ,OfficeBuildingIcon, CurrencyDollarIcon, HandIcon
...
const options = ref([
  ...
  { label: 'Warehouse Requisitions', icon: OfficeBuildingIcon, path: '/planner/warehouserequisitions' },
    ...
    { label: 'Commodity Loans', icon: CurrencyDollarIcon, path: '/planner/loans' },
