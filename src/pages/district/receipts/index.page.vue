...
const options = ref([
  { label: 'Lean Season Response Receipts', icon: TemplateIcon, path: '/district/receipts/leanseason' },
  { label: 'Emergency Response Receipts', icon: LightningBoltIcon, path: '/district/receipts/emergency' },
