    ...
    <div class="w-full">
      ...
      <div class="flex flex-col sm:flex-row justify-between items-center rounded-md">
        <span class="text-white font-bold text-center sm:text-left mb-4 sm:mb-0">
          Commodity Distribution Report (Emergency Response)
        </span>
      </div>
      ...
      <div class="overflow-x-auto bg-white p-4 sm:p-6 rounded-lg shadow-lg mt-4">
        <!-- Filter Section -->
        <div class="flex flex-col md:grid md:grid-cols-3 lg:grid-cols-4 gap-4 mb-4" :class="{ 'hidden': screenshotMode }">
          ...
          <div class="flex items-end">
            <button
              @click="resetFilters"
              class="bg-gray-200 hover:bg-gray-400 text-black font-medium py-1 px-2 text-sm rounded w-full sm:w-auto"
            >
              Reset
            </button>
          </div>
          ...
          <div class="flex items-end">
            <button
              ...
              class="bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded w-full sm:w-auto"
            >
              Export
            </button>
          </div>
        ...
        <!-- Pagination Controls -->
        <div
          class="flex flex-col sm:flex-row justify-between items-center mt-4 space-y-4 sm:space-y-0"
