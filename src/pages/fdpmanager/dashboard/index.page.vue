              ...
              >
                <noscript>
                  <a href="#">
                    <img
                      alt="main page"
                      src="https://public.tableau.com/static/images/te/test_20190116Urban_vulnerability_ideasFR_0/mainpage/1_rss.png"
                      style="border: none"
                    />
                  </a>
                </noscript>
                <object class="tableauViz" style="display: none">
                  ...
                  <param
                    name="name"
                    value="test_20190116Urban_vulnerability_ideasFR_0&#47;mainpage"
                  />
                  <param name="tabs" value="no" />
                  <param name="toolbar" value="yes" />
                  <param
                    name="static_image"
                    value="https://public.tableau.com/static/images/te/test_20190116Urban_vulnerability_ideasFR_0/mainpage/1.png"
                  />
...
const columns = ref([
  ...
  {
    label: "ATC #",
    field: (row) => row.loadingPlan?.ATCNumber,
    sortable: true,
    firstSortType: "asc",
  },
  {
