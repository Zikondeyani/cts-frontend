        ...
        <div class="flex min-h-screen text-center md:block md:px-2 lg:px-4" style="font-size: 0">
          ...
          <TransitionChild as="template" enter="ease-out duration-300"
            ...
            <div
              ...
              <form @submit="onSubmit" :validation-schema="CreateTransporterSchema">
...
//SCHEMA AND STORES
import { CreateTransporterSchema } from "../../../services/schema/transporter.schema";
//INJENCTIONS
...
//FORM
const { meta } = useForm({
  validationSchema: CreateTransporterSchema,
  initialValues: {
    Name: "",
