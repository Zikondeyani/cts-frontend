                ...
                <div class="grid grid-cols-6 gap-6">
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <select id="status" name="status" v-model="model.status" autocomplete="status-name"
                      class="mt-1 focus:ring-gray-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-400 rounded-md">
          ...
          <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="space-y-2">
              <div v-for="(item, index) in checklistItems" :key="index" class="flex items-center">
                <input type="checkbox" class="rounded border-gray-400 text-blue-500 focus:ring-blue-400 h-4 w-4"
            ...
            <div class="mt-4">
              <input v-model="newItem" @keyup.enter="addItem"
                class="rounded border-gray-400 text-gray-700 focus:ring-blue-400 py-2 px-4" placeholder="Add a new checklist item"
                @change="updateChecklistItem(item)" />
              <button @click="addItem" class="ml-2 rounded bg-[#096eb4] text-white px-4 py-2">Add</button>
            </div>
