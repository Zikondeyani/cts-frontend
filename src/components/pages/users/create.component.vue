          ...
          <TransitionChild as="template" enter="ease-out duration-300"
            ...
            <div
              ...
              <form @submit="onSubmit" :validation-schema="CreateUserSchema"
                v-if="roleId == 'ADMIN1' || roleId == 'ADMIN2' || roleId == 'ADMIN3' || roleId == 'ADMIN4' || roleId == 'ADMIN5' || roleId == 'ADMIN6' || roleId == 'ADMIN7' || roleId == 'ADMIN8' || roleId == 'ADMIN9' || roleId == 'ADMIN10'">
                  ...
                  <div class="grid grid-cols-6 gap-2">
                    ...
                    <div class="col-span-12 sm:col-span-12" v-if="roleId == 'ADMIN6'">
                      ...
                      <div class="mt-2">
                        <select v-model="selectedPrivilege" @change="addPrivilege"
                          class="mt-1 block w-full py-2 px-3 border border-gray-400 bg-white rounded-md shadow-sm focus:outline-none focus:ring-gray-500 focus:border-blue-300 sm:text-sm">
                    ...
                    <div class="col-span-12 sm:col-span-12" v-if="roleId == 'ADMIN2'">
                      ...
                      <select v-model="isDelegated"
                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
