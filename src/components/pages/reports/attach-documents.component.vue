  ...
  <div v-if="isOpen" class="fixed z-10 inset-0 overflow-y-auto" @click.self="$emit('close')">
    ...
    " target="_blank" class="text-blue-600 hover:text-blue-900">
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <button type="button"
            class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-400 text-base font-medium text-white hover:bg-[#096eb4] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm"
