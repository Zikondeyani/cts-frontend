    ...
    <Dialog as="div" class="fixed inset-0 z-10 overflow-y-auto" @close="closeDialog" static>
      <div class="flex items-start justify-center min-h-screen px-2 pt-4 pb-4 text-center sm:block sm:p-0">
        ...
        <TransitionChild as="template" enter="ease-out duration-300"
          ...
          <div
            class="inline-block align-top bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:align-start sm:my-8 sm:max-w-4xl sm:w-full mobile-form-shell mx-auto">
