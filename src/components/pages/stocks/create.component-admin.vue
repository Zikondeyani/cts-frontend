      ...
      <Dialog as="div" class="fixed z-10 inset-0 overflow-y-auto" @close="open = false" static>
        <div class="flex items-center justify-center min-h-screen px-4">
          ...
          <TransitionChild as="template" enter="ease-out duration-300"
            ...
            <div
              class="font-body text-base text-left mx-5 transform transition w-full max-w-lg md:max-w-2xl lg:max-w-2xl sm:px-6 sm:py-4 bg-white rounded-md shadow-md">
              <div class="modal-header flex items-center justify-between p-4 border-b border-gray-200 rounded-t-md bg-white">
                <h5 class="text-lg font-medium leading-normal text-gray-800" id="formModalLabel">
                  Create Stock
                </h5>
                <button type="button"
                  class="btn-close w-6 h-6 p-1 text-black border-none rounded-none opacity-50 focus:shadow-none focus:outline-none focus:opacity-100 hover:text-black hover:opacity-75 hover:no-underline"
                  @click="open = false">
                </button>
              </div>
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="col-span-1">
                      ...
                      <ul v-if="filteredCommodities.length"
                        class="border border-gray-400 rounded-md mt-2 max-h-48 overflow-y-auto">
