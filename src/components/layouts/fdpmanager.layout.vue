...
const onAbout = async () => {
  $router.push({ path: "/fdpmanager/about-system" });
};
...
function gotoSystemsettings() {
  $router.push({ path: "/fdpmanager/system" });
}
...
function navigation() {
  let navList = [
    { name: "Home", href: "/fdpmanager/dashboard", icon: HomeIcon, current: false },

    {
      name: "FDP Management",
      href: "/fdpmanager/fdps",
  ...
  navList.forEach((navItem) => {
    const isMatched =
      ...
      (navItem.name === "Plan & Dispatch" &&
        (currentRouteBase.startsWith("/fdpmanager/loadingplans") ||
          currentRouteBase.startsWith("/fdpmanager/dispatches"))) ||
      (navItem.name === "Receipts" &&
        currentRouteBase.startsWith("/fdpmanager/receipts")) ||
      (navItem.name === "System" &&
        (currentRouteBase.startsWith("/fdpmanager/userroles") ||
          currentRouteBase.startsWith("/fdpmanager/mailinggroups") ||
          currentRouteBase.startsWith("/fdpmanager/reminders") ||
          currentRouteBase.startsWith("/fdpmanager/about") ||   
          currentRouteBase.startsWith("/fdpmanager/change-password") ||
          currentRouteBase.startsWith("/fdpmanager/receipts/leanseason") ||
          currentRouteBase.startsWith("/fdpmanager/usage-stats") ||
          currentRouteBase.startsWith("/fdpmanager/performance-stats") ||
          currentRouteBase.startsWith("/fdpmanager/users") ||
          currentRouteBase.startsWith("/fdpmanager/logs") ||
          currentRouteBase.startsWith("/fdpmanager/fdps") ||
          currentRouteBase.startsWith("/fdpmanager/feedback") ||
          currentRouteBase.startsWith("/fdpmanager/user-dispatches") ||
          currentRouteBase.startsWith("/fdpmanager/districts") ||
          currentRouteBase.startsWith("/fdpmanager/organisations") ||
          currentRouteBase.startsWith("/fdpmanager/commodity-types") ||
          currentRouteBase.startsWith("/fdpmanager/commodity-management")));
